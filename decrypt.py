...
im = Image.open('C:\Image-Cryptography\encrypted_images/' + sys.argv[1])
pix = im.load()
...
print('Enter value of Kr',int())
Kr = list(map(int, str(input()).split(',')))

print('Enter value of Kc')
Kc = list(map(int, str(input()).split(',')))
